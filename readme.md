...
|                   온보딩 화면                   |
|:------------------------------------------:|
| <img src="exec/video/온보딩.gif" width="300"> |
...
| 메인 홈 |                    개인 러닝 시작                    |
| :---: |:----------------------------------------------:|
| <img src="exec/image/메인_홈.png" width="300"> | <img src="exec/video/개인러닝_시작.gif" width="300"> |

|                   개인 러닝 진행 중                    |                     개인 러닝 결과                      |
|:-----------------------------------------------:|:-------------------------------------------------:|
| <img src="exec/video/개인러닝_진행중.gif" width="300"> |  <img src="exec/image/개인_러닝_결과.png" width="300"> |


<br>

### 4️⃣ 챌린지 진행 화면 및 중계방 스트리밍 

> 챌린지 진행 상황을 실시간 중계하며, AI가 중계 메세지를 생성합니다.

|              챌린지 진행 화면 및 중계방 스트리밍              |
|:----------------------------------------------:|
| <img src="exec/video/챌린지및중계방.gif" width="700"> |
...
|                   러닝 기록 및 통계                    |
|:-----------------------------------------------:|
| <img src="exec/video/마이페이지_통계.gif" width="300"> |
...
|                      마이페이지                      |
|:-----------------------------------------------:|
| <img src="exec/image/마이페이지_수정.png" width="300"> |
